...
LumaVibe_Error_t LumaVibe_begin() {
  ...
  if (MMA8451_setLowNoiseMode(&accel, MMA8451_LOWNOISE_OFF) != ESP_OK) return LUMAVIBE_ERROR_SENSOR_SETTING;
  if (MMA8451_setRange(&accel, MMA8451_RANGE_4G) != ESP_OK) return LUMAVIBE_ERROR_SENSOR_SETTING;
